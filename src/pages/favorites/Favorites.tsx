        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 w-full sm:w-auto">
          ...
          {favorites.length > 0 && (
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
              <div className="flex bg-purple-900/30 backdrop-blur-sm rounded-full p-1 w-full sm:w-auto justify-center">
                <button
              ...
              <div className="flex bg-purple-900/30 backdrop-blur-sm rounded-full p-1 w-full sm:w-auto justify-center">
                <button
                  ...
                  className={`px-3 py-1 rounded-full transition-all duration-300 flex items-center gap-1 text-purple-200 hover:text-white flex-1 sm:flex-none justify-center`}
                >
                  {selectedGenre ? (
