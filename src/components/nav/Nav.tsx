...
export default function Nav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 w-full bg-gradient-to-r from-gray-800/95 via-gray-900/95 to-gray-800/95 backdrop-blur-md flex justify-between items-center px-4 md:px-12 py-2 md:py-3 z-[99999] shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.3)] border-t border-gray-700/30">
